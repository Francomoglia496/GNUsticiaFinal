...
public class Expediente {
    ...
    //metodo que realiza la busqueda de los numeros de expedientes que se encuentran en la base de datos
...
//>>>>>>> 781ce44c418aae29ff93f13cb69497562d3ae163
    ...
    /*
    * Metodo que permite la creacion de
    ...
    */
    ...
    public static Collection BusquedaExpedientes() throws IOException {

        ArrayList<String> listaexp = new ArrayList<String>();

        Localidad resistencia = Localidad.resistencia();

        String[] exptesList = BaseDatosMySQL.BuscarExpedientesPropios();
